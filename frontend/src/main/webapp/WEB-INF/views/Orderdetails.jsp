    ...
    <div class="card card-1">
        <div class="card-header bg-white">
            <div class="media flex-sm-row flex-column-reverse justify-content-between ">
                <div class="col my-auto">
                    <h4 class="mb-0">Thanks for your Order,<span class="change-color">ishu</span> !</h4>
                </div>
                <div class="col-auto text-center my-auto pl-0 pt-sm-4"> <img class="" src="" width="115" height="115">
                    <p class="mb-4 pt-0 product">product For Everyone</p>
                </div>
            </div>
        </div>
        <div class="card-body">
            ...
            <div class="row">
                <div class="col">
                    <div class="card card-2">
                        <div class="card-body">
                            <div class="media">
                                <div class="sq align-self-center "> <img class="" src="" width="135" height="135" /> </div>
                                <div class="media-body my-auto text-right">
                                    <div class="row my-auto flex-column flex-md-row">
                                        <div class="col my-auto">
                                            <h6 class="mb-0"> ramya</h6>
                                        </div>
                                        <div class="col-auto my-auto"> <small>laptop </small></div>
                                        <div class="col my-auto"> <small>Size : </small></div>
                                ...
                                <div class="media-body my-auto text-right">
                                    <div class="row my-auto flex-column flex-md-row">
                                        <div class="col-auto my-auto ">
                                            <h6 class="mb-0"> ishu</h6>
                                        </div>
                                        <div class="col my-auto "> <small>mobile </small></div>
                                        <div class="col my-auto "> <small>Size : </small></div>
                                        <div class="col my-auto "> <small>Qty : 1</small></div>
                                        <div class="col my-auto ">
                                            <h6 class="mb-0">&#8377;8000.00</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="card-footer">
            <div class="jumbotron-fluid">
                <div class="row justify-content-between ">
                    <div class="col-sm-auto col-auto my-auto"><img class=" " src="" width="115" height="115"></div>
                    <div class="col-auto my-auto ">
